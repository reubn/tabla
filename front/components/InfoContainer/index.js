...
const mapStateToProps = ({periodicTable: {selectedElement}}) => ({elementSelected: selectedElement !== null, element: {...elements[selectedElement], atomicNumber: selectedElement}})
